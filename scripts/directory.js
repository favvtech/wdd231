(function () {
  ...
  function createCard(member) {
    ...
    if (member.image) {
      ...
      img.src = "../images/" + member.image; // expects image files to be placed in root images
  ...
  function renderMembers(members) {
    ...
    sorted.forEach(function (m) {
      // For level 1 (basic member), keep minimal card content
  ...
  // Initialize default view and load
  setView("grid");
  loadMembers();
})();
